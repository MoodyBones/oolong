...
export default function Home() {
  ...
  const handleSelect = useCallback((stage: StoryStage) => {
    ...
    <main className="min-h-screen">
      ...
      <section className="px-6 py-20 md:py-32">
        <div className="mx-auto max-w-[800px]">
          <h1 className="text-4xl font-bold tracking-tight md:text-6xl">Hope comes from action.</h1>
          <p className="mt-4 text-xl text-muted-foreground md:text-2xl">
            Real stories of career barriers and what people did next. Not inspiration. Pattern
            recognition.
          </p>

          <div className="mt-12">
            <MirrorSelector selected={selectedStage} onSelect={handleSelect} />
          </div>
        </div>
      </section>
      ...
      <section id="browse" className="px-6 py-16 md:py-24">
        <div className="mx-auto max-w-[800px]">
          <h2 className="text-3xl font-bold md:text-4xl">The pattern so far.</h2>
          <p className="mt-2 text-muted-foreground">
            {stories.length} stories. Each one a barrier, a reflection, an action, a transformation.
          </p>
      ...
      <section className="border-t bg-surface px-6 py-16 md:py-24">
        <div className="mx-auto max-w-[800px] text-center">
          <h2 className="text-3xl font-bold md:text-4xl">Add your data point.</h2>
          <p className="mx-auto mt-4 max-w-[600px] text-muted-foreground">
            Your story is anonymous unless you choose otherwise. We aggregate patterns, not personal
            details.
          </p>
          <div className="mt-8">
            <Button
      ...
      <footer className="border-t px-6 py-12">
        <div className="mx-auto max-w-[800px]">
          <p className="text-sm text-muted-foreground">Built by Mel Jones in Melbourne.</p>
        </div>
      </footer>
    </main>
  );
