...
- **Low arousal** (tired, flat): Need gentle activation → Version 3, body-first interventions
- **Optimal** (focused, curious): Ready to engage → Version 1 or 2
- **High arousal** (anxious, scattered): Need calming → Version 3 + grounding, or Template 11
...
- Grounding → tiny action = Optimal arousal for task
...
**Core shift:**
- Old model: Push through fatigue → Burnout → Recovery
- New model: Honor signals → Sustainable pace → Consistent output
...
- Your arousal is dysregulated (too high/low) → Need regulation first
- Time pressure → Need fastest path to action
- Overthinking → Need to bypass analysis paralysis
- **Learning:** Arousal regulation, reducing activation energy

**Claude suggests Version 1 when:**
- Optimal arousal state → Can engage with structure
- Need quick focus → Efficient MI process
- Multiple pulls → Need prioritization
- **Learning:** Motivational interviewing, task initiation science

**Claude suggests Version 2 when:**
- Good energy + want autonomy → Practice self-awareness
- Previous versions felt rigid → Exploring what works
- Building metacognitive skills → Learn to self-diagnose
- **Learning:** Activist mindset (agency), metacognition

**Claude suggests Full Version when:**
- Open to deep reflection → Capacity for introspection
- Disconnected from purpose → Need values realignment
- Time and energy available → Can integrate all elements
- **Learning:** All principles integrated, deep self-coaching

**Claude suggests Template 11 (Wellbeing) when:**
- Very depleted → Task activation would be harmful
- Multiple struggles → Need to address root cause
- Guilt about not working → Self-compassion needed first
...
Read the vibe:
- 😴🥱 = Low energy
- 🤔💭🌀 = Overthinking/scattered
- ⚡✨ = High energy, need direction
- 😰😬 = Anxious/stressed
- 😊🌱 = Good baseline
- 🎨🔥 = Creative/excited
- 😶😐 = Flat/unmotivated
...
Listen for:
- "Avoiding [specific thing]" → Need permission/easier entry
- "Don't know where to start" → Need tiny action
- "Overwhelmed" → Need wellbeing check first
- "Excited about [thing]" → Channel that energy
- "Multiple things pulling" → Need focus
- "Low energy but should work" → Need sustainable approach
- "Planning instead of doing" → Need grounding
...
**Which question:**
- Avoiding → "What do you feel like doing?"
- Stuck → "What's the tiniest action?"
- Lost purpose → "What lights you up?"
...
- Very low energy + guilt → Template 11 (wellbeing-checkin.md)
- Stuck for multiple days → Template 10 (challenging-assumptions.md)
- Have chosen a specific ticket → Relevant task template (03-vps, 04-frontend, 05-backend)
- Lost in planning → Version 3 + "Open [specific file] and make one change"
...
**If they override:**
- "Actually, just tell me what to do" → Skip to directive action
- "Give me Version X" → Run that version
- "Make it faster/slower" → Adjust accordingly
...
**If they say:**
- "I can't even do this prompt" → *"That's important data. Open template 11-wellbeing-checkin.md instead. Something needs attention first."*

- "Just tell me what to do" → *"Open [specific file/app]. Do [one action]. 20 minutes. That's it."*

- "I'm avoiding [specific thing]" → *"What's a different part of the project that energises you? Let's start there instead."*
...
- Very stuck → Template 10 (challenging-assumptions)
- Low energy + guilt → Template 11 (wellbeing)
- Need technical help → Templates 03-05 (task-specific)
- Before sharing → Template 06 (stakeholder-plan)
...
- User goes from "can't start" → "working on something" in under 5 minutes
...
**Goal:** From stuck → working in under 5 minutes.
...
✅ **Context-aware** (knows the project)  
✅ **Milestone-integrated** (knows where they are)  
